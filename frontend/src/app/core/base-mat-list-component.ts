 ...
 * @class
 */
export abstract class BaseMatListComponent<TEntity, TListFormParams extends ListFormParams> implements OnInit, OnDestroy {
    ...
    /**
     * Initializes a new instance of the {BaseMatListComponent}
     * @constructor
...
export class CustomDataSource<TEntity, TListFormParams extends ListFormParams> extends DataSource<TEntity> {
     ...
     */
    constructor(private _component: BaseMatListComponent<TEntity, TListFormParams>,
        private _paginator: MatPaginator, public _sort: MatSort) {
        super();
    }
