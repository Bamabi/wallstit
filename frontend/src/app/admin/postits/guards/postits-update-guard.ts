 ...
 */
@Injectable()
export class PostitsUpdateGuard extends BaseRigthsGuard {
  /**
   * Initialize the PostitsUpdateGuard class.
   * @constructor
  ...
  constructor(
    ...
    super(authorizationGuardService, storageService, router, 'R_API_POSTIT_U');
  }
}
