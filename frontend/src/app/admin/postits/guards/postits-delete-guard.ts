 ...
 */
@Injectable()
export class PostitsDeleteGuard extends BaseRigthsGuard {
  /**
   * Initialize the PostitsDeleteGuard class.
   * @constructor
  ...
  constructor(
    ...
    super(authorizationGuardService, storageService, router, 'R_API_POSTIT_D');
  }
}
